        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ButtonTheme(
              ...
              child: RaisedButton(
                onPressed: () => {
                  if (_controllerUname.text == '' || _controllerCell.text == '')
                    {
                      showDialog(
                        context: context,
                    ...
                    {
                      db.collection("dadosUsuarios").doc(idUsuarioLogado).set({
                        "username": _controllerUname.text,
                        "telefone": _controllerCell.text,
                        "UF": dropdownValue,
                        "tipoUsuario": selectRadio
                      }).then((firebaseUser) {
                        Navigator.push(
                          context,
